  ...
  createPagination(lastPage, start, end, leftDots, rightDots, firstPage = 1) {
    ...
    if (firstPage) {
      ...
      paginationList.insertAdjacentHTML(
        "beforeend",
        `<button class="pagination__link${paginationStart}" name="page">1</button>`
      );
    }
    ...
    for (let i = start; i <= end; i += 1) {
      ...
      paginationList.insertAdjacentHTML(
        "beforeend",
        `<button class="pagination__link${paginationClass}" name="page">${i}</button>`
      );
    }
    ...
    if (lastPage) {
      ...
      paginationList.insertAdjacentHTML(
        "beforeend",
        `<button class="pagination__link${paginationEnd}" name="page">${lastPage}</button>`
      );
    }
  }
